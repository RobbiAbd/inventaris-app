...
async function main() {
  ...
  const barangSamples = [
    { nama: 'Laptop Dell Latitude', kategori: 'LAPTOP', merk: 'Dell', nomorSeri: 'DL-LAT-001', status: 'BAIK', tipePerolehan: 'BELI', lokasi: 'Ruang HRD', tanggalPembelian: new Date('2023-01-15'), userId: seededUsers['hrd@inventaris.local'] },
    { nama: 'Printer Canon', kategori: 'ELEKTRONIK', merk: 'Canon', nomorSeri: 'CN-PR-002', status: 'DALAM_PERBAIKAN', tipePerolehan: 'BELI', lokasi: 'Ruang Admin', tanggalPembelian: new Date('2022-06-10'), userId: seededUsers['karyawan@inventaris.local'] },
    ...
    { nama: 'Meja Kerja', kategori: 'FURNITURE', merk: 'Informa', nomorSeri: 'FN-MK-003', status: 'BAIK', tipePerolehan: 'BELI', lokasi: 'Open Space', tanggalPembelian: new Date('2021-03-20') }
  ]
